                                    ...
                                    <div class="group-input">
                                        ...
                                        <div class="dropdown">
                                            <div class="dropdown-select">
                                                <span class="select selected-start">Từ 6 - 12 tuổi</span>
                                                <i class="fa-regular fa-chevron-down dropdown-icon"></i>
                                            </div>
                                            <div class="dropdown-list">
                                                <div class="dropdown-content">
                                                    <div class="dropdown-list-item select-start">Cần Thơ</div>
                                                    <div class="dropdown-list-item select-start">Hồ Chí Minh</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
