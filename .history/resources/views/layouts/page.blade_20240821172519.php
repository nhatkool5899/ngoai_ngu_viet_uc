...
<body>
    <div class="app">
        ...
        <main>
            ...
            <section class="section bg-register" style="background-image: url({{asset('front-end/assets/imgs/bg-register.jfif')}})">
                <div class="container">
                    <div class="box_register">
                        <div class="form_register">
                            <div class="head_register">
                                ĐĂNG KÝ LỚP HỌC THỬ MIỄN PHÍ NGAY BÂY GIỜ!
                            </div>
                            <form class="form_main">
                                ...
                                <div class="group_input">
                                    <input type="text" class="form-control" placeholder="Khóa học đăng ký (*)">
                                </div>
                                <div class="group_input">
                                    <textarea name="" rows="8" class="form-control-area" placeholder="Lời nhắn"></textarea>
                                </div>
                                <div class="accept">
                                    <label class="group-label" for="input-checkbox">
                                        <input type="checkbox" name="remember" id="input-checkbox" style="display: none">
                                        <span></span>
                                    </label>
                                    <div>Bằng việc đăng ký thông tin, bạn đồng ý cho phép Việt Úc liên lạc thông qua các hình thức: cuộc gọi, tin nhắn, email nhằm mục đích tư vấn các chương trình Anh ngữ & nghiên cứu thị trường.</div>
                                </div>
                                <div class="group_input" style="text-align: center; margin-bottom:20px">
                                    <button class="btn_register">Đăng ký ngay</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="ft_elementor">
                        <div class="ft_info">
                            ...
                            <div class="ft_desc">
                                Chúng tôi tin vào sức mạnh của trò chơi trong việc thúc đẩy khả năng sáng tạo, kỹ năng giải quyết vấn đề và trí tưởng tượng.
                            </div>
                            <div class="ft_social">
                                <div class="ft_social-item">
                                    <i class="fa-solid fa-envelope"></i>
                                    <span>ngoainguvietuceducation@gmail.com</span>
                                </div>
                                <div class="ft_social-item">
                                    <i class="fa-sharp fa-solid fa-phone"></i>
                                    <span>0934-163-034</span>
                                </div>
                                <div class="ft_social-item">
                                    <i class="fa-solid fa-location-dot"></i>
                                    <span>Số 36/7,  đường Trần Phú, Phường 4, TP. Vĩnh Long</span>
                                </div>
                            </div>
                        </div>
                        <div class="ft_redirect"></div>
                    </div>
                </div>
            </div>
        </footer>
