                    ...
                    <div class="study_program">
                        <div class="study_item">
                            ...
                            <div class="study_context">
                                <div class="study_name">Bứt phá tiếng Anh Trung học cơ sở cùng Việt - Úc</div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="menu_news-item">
                                            <img src="{{asset('front-end/assets/imgs/news/1.jfif')}}" alt="1-image">
                                            <div class="menu_news-context">
                                                <h4> Summer Festival: Lễ hội mùa hè sôi động và ý nghĩa của hơn 3.000 bạn nhỏ </h4>
                                                <p>Khép lại lễ hội mùa hè  Summer Festival vào ngày 19/7, hơn 3.000 bạn nhỏ đã làm bùng nổ sân vận động Hoa Lư với hàng trăm sắc màu rực rỡ! Lễ hội Summer Festival 2024 không chỉ là một sự kiện…</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
